...
public class TrustworthinessCalculatorTest {
    ...
    public void baseScoreIsHighForSolidStatement() {
        TrustworthinessScore s = new TrustworthinessCalculator().score(solidStatement(), 0, null, false, 0, 0, EmploymentType.EMPLOYEE);
        assertTrue("base should be high", s.base >= 80);
        assertEquals(0, s.adjustment);
        assertEquals(0, s.externalBuff);
        assertEquals(0, s.questBuff);
    ...
    public void externalRatingGivesOnlyASmallCappedBuff() {
        TrustworthinessScore low = new TrustworthinessCalculator().score(solidStatement(), 0, null, false, 0, 0, EmploymentType.EMPLOYEE);
        TrustworthinessScore high = new TrustworthinessCalculator().score(solidStatement(), 999, null, false, 0, 0, EmploymentType.EMPLOYEE);
    ...
    @Test
    public void questBonusIsCappedAndNeverNegative() {
        TrustworthinessScore s = new TrustworthinessCalculator().score(solidStatement(), 0, null, false, 999, 0, EmploymentType.EMPLOYEE);
        assertEquals(TrustworthinessScore.QUEST_CAP, s.questBuff);

        TrustworthinessScore negative = new TrustworthinessCalculator().score(solidStatement(), 0, null, false, -50, 0, EmploymentType.EMPLOYEE);
        assertEquals(0, negative.questBuff);
    }

    @Test
    public void habitsBonusIsCappedBothWays() {
        TrustworthinessScore positive = new TrustworthinessCalculator().score(solidStatement(), 0, null, false, 0, 999, EmploymentType.EMPLOYEE);
        assertEquals(TrustworthinessScore.HABITS_CAP, positive.habitsBuff);

        TrustworthinessScore negative = new TrustworthinessCalculator().score(solidStatement(), 0, null, false, 0, -999, EmploymentType.EMPLOYEE);
    ...
    public void noConsentMeansNoTelegramAdjustment() {
        ...
        TrustworthinessScore s = new TrustworthinessCalculator().score(solidStatement(), 500, t, false, 0, 0, EmploymentType.EMPLOYEE);
        assertEquals(0, s.adjustment);
    }
    ...
    public void workMentionsRaiseScoreWithinCap() {
        ...
        TrustworthinessScore s = new TrustworthinessCalculator().score(solidStatement(), 500, t, true, 0, 0, EmploymentType.EMPLOYEE);
    ...
    public void freelancerGetsASofterRegularityCeilingThanEmployee() {
        ...
        TrustworthinessScore employee = new TrustworthinessCalculator().score(a, 0, null, false, 0, 0, EmploymentType.EMPLOYEE);
        TrustworthinessScore freelancer = new TrustworthinessCalculator().score(a, 0, null, false, 0, 0, EmploymentType.FREELANCER);
    ...
    public void mfoHitsApplyACappedPenalty() {
        ...
        TrustworthinessScore s = new TrustworthinessCalculator().score(a, 0, null, false, 0, 0, EmploymentType.EMPLOYEE);
        ...
        TrustworthinessScore s2 = new TrustworthinessCalculator().score(clean, 0, null, false, 0, 0, EmploymentType.EMPLOYEE);
